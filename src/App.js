...
function App() {
  const perfil = {
    ...
    imagem: imagemPerfil,
    descricao:
      "Iniciei minha carreira como treinador pokémon, especializado em pokémons de pedra e, atualmente sou líder do estádio de Pewter City.",
    ...
    experiencia: [
      {
        ...
        icone: iconeEstadio,
        descricao:
          "Atualmente sou o líder do Estádio de Pewter City, sou responsável pelo gerenciamento do estádio, batalhas e entrega da insígnia para treinadores pokémon desafiantes que chegam ao estádio.",
      },
      {
        empresa: "Treinador pokémon - freelancer",
        icone: iconePedra,
        descricao:
          "Fui treinador pokémon durante a juventude. Acompanhei Ash Ketchum e Misty na busca por insígnias. Participei da franquia de filmes e algumas temporadas da série original.",
      },
    ],
  };
  return (
    <ContainerApp>
      ...
      <SectionPagina>
        ...
        <ImagemButton imagem={downArrow} texto="Ver mais" />
      </SectionPagina>
      ...
      <SectionPagina>
        ...
        <ImagemButton imagem={iconeFB} texto="Facebook" />
        <ImagemButton imagem={iconeTT} texto="Twitter" />
      </SectionPagina>
    </ContainerApp>
  );
}
